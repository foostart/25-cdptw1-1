...
<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Motors Classified." href="http://motors.stylemixthemes.com/classified" class="home"><span property="name">Motors Classified</span></a><meta property="position" content="1"></span> &gt; <span property="itemListElement" typeof="ListItem"><span property="name">Pricing</span><meta property="position" content="2"></span>         </div>
        </div>
      </div>
    ...
    <div class="container">
        ...
        <div class="vc_row wpb_row vc_row-fluid"><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="stm-pricing stm-pricing_3" id="stm-pricing-5ca812bd4a5c8">
      ...
      <div class="stm-pricing__tables-row clearfix">
              ...
              <div class="stm-pricing__tables-col-inner">
                ...
                <div class="stm-pricing-table heading-font">
                            ...
                            <a href="../checkout/indexbc8c.html?add-to-cart=2291" class="button">Sign Up<i class="stm-icon stm-icon-arrow-right"></i></a>
                          </div>
                                              </div>
                                              ...
                                              <li class="stm-pricing-table__feature">
                                                    ...
                                                    <div class="stm-pricing-table__feature-value">
                                                          <i class="fa fa-check"></i>
                                                                              ...
                                                                              <div class="stm-pricing-table__periods-link stm-pricing-table__periods-item_active" data-period="month">
                                                  <div class="stm-pricing-table__action">
                            <a href="../checkout/index8b2d.html?add-to-cart=2292" class="button">Get Business<i class="stm-icon stm-icon-arrow-right"></i></a>
                          </div>
                                              </div>
                                          <div class="stm-pricing-table__periods-link" data-period="yearly">
                                                  <div class="stm-pricing-table__action">
                                              ...
                                              <li class="stm-pricing-table__feature">
                                                    ...
                                                    <div class="stm-pricing-table__feature-value">
                                                          Yes                                                     </div>
                                                                              ...
                                                                              <div class="stm-pricing-table__periods-link stm-pricing-table__periods-item_active" data-period="month">
                                                  <div class="stm-pricing-table__action">
                            <a href="../checkout/index610d.html?add-to-cart=2294" class="button">Get Enterprise<i class="stm-icon stm-icon-arrow-right"></i></a>
                          </div>
                                              </div>
                                          <div class="stm-pricing-table__periods-link" data-period="yearly">
                                                  <div class="stm-pricing-table__action">
